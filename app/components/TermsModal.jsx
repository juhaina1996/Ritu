          ...
          >
            ...
            <div className="space-y-5 text-sm text-[#3F3428] leading-relaxed">
              <p>
                ...
                using this website, you agree to comply with the following Terms
                & Conditions.
              </p>

              <p>
                Project Ritu is developed and promoted by{" "}
                <strong>S Zone Developers LLP</strong> (“SZ Developers”). All
                references to “Project Ritu” relate to this project.
              </p>
              ...
              <p>
                Project Ritu, including its name, logo, branding, and
                trademarks, is owned by S Zone Developers LLP. Unauthorized use
                is prohibited.
              </p>
              ...
              <p>
                All website content is the intellectual property of S Zone
                Developers LLP and may not be reproduced without permission.
              </p>
              ...
              <h3 className="text-lg font-semibold mt-6">8. Governing Law</h3>
              <p>
